                ...
                @foreach($galleries as $gallery)
                    ...
                    <div class="admin-galeri-card group overflow-hidden rounded-[1.75rem] border border-gray-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                        <div class="relative">
                            ...
                            @else
                                <img src="{{ public_media_url($gallery->imej ?? null) }}" alt="Gallery" class="h-52 w-full object-cover transition duration-300 group-hover:scale-105">
                        ...
                        <div class="space-y-4 p-4">
                            ...
                            <div class="flex flex-col gap-2">
                                <button
                                    ...
                                    data-src="{{ public_media_url($gallery->imej ?? null) }}"
