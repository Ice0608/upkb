    ...
    <section class="max-w-6xl mx-auto px-6 py-10">
        ...
        <div class="rounded-3xl bg-white shadow-lg overflow-hidden border border-gray-100 mb-10">
            ...
            <div class="p-8">
                ...
                <a href="{{ route('pelajar.welcome', $pelajar->id) }}" class="inline-flex items-center gap-2 text-blue-600 font-bold hover:text-blue-800">
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <a href="{{ route('pelajar.infokursus', ['pelajar' => $pelajar->id, 'kod_institusi' => $kursus->kod_institusi, 'kod_kursus' => $kursus->kod_kursus]) }}" class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 font-semibold">Lihat detail</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
