            ...
            <div class="grid md:grid-cols-[1.8fr,0.8fr] gap-6 p-8">
                <div>
                    ...
                    <div class="mt-8 flex flex-wrap gap-4">
                        <a href="{{ route('pelajar.infoinstitusi', ['pelajar' => $pelajar->id, 'kod_institusi' => $kursus->kod_institusi]) }}" class="inline-flex items-center gap-2 rounded-full bg-white text-orange-600 px-6 py-3 font-semibold shadow-lg hover:bg-white/90 transition">
