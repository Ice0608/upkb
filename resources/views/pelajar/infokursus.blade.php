...
@include('layouts.navpelajar')
    ...
    <script>
        ...
        function printCourseInfoSections() {
            ...
            const tabs = [
                { title: 'Maklumat Am', url: tabUrls.maklumat },
                { title: 'Syarat Kelayakan', url: tabUrls.syarat },
                { title: 'Laluan Kerjaya', url: tabUrls.kerjaya },
                { title: 'Yuran & Pinjaman', url: tabUrls.yuran },
                { title: 'Galeri', url: tabUrls.galeri },
            ];
