...
@php
    $pelajarId = request()->route('pelajar');
    if ($pelajarId instanceof \App\Models\Pelajar) {
        $pelajarId = $pelajarId->id;
    }
@endphp
    ...
    <div class="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div class="ml-auto hidden items-center gap-2 lg:flex">
            <div class="site-nav-program relative">
                <a href="{{ $pelajarId ? route('staff.temuduga.program', $pelajarId) : route('program') }}" class="site-nav-link {{ request()->routeIs('staff.temuduga.program') ? 'is-active bg-orange-50 text-orange-600' : 'text-slate-700 hover:bg-slate-50 hover:text-orange-500' }} inline-flex items-center rounded-full px-4 py-3 text-sm font-semibold">
                    Program
                </a>
                ...
                <div class="site-nav-program-panel absolute left-1/2 top-full z-20 w-[min(92vw,32rem)] pt-4">
                    <div class="site-nav-program-shell rounded-[2rem] p-3 sm:p-4">
                        ...
                        <div class="grid gap-3 md:grid-cols-3">
                            <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'TVET']) : route('kursus.index', ['jenis' => 'TVET']) }}" class="site-nav-program-card site-nav-program-card-tvet site-nav-program-card-floating rounded-[1.9rem] px-5 py-5 text-white [animation-delay:0s]">
                            ...
                            <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'Diploma']) : route('kursus.index', ['jenis' => 'Diploma']) }}" class="site-nav-program-card site-nav-program-card-diploma site-nav-program-card-floating rounded-[1.9rem] px-5 py-5 text-white [animation-delay:0.4s]">
                                <span class="site-nav-program-card-glow"></span>
                                <span class="site-nav-program-card-badge inline-flex rounded-full bg-white/18 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/90">Kategori</span>
                                <div class="mt-6 flex min-h-[7.25rem] items-end justify-between gap-4">
                                    <div>
                            ...
                            <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'Sains Kesihatan']) : route('kursus.index', ['jenis' => 'Sains Kesihatan']) }}" class="site-nav-program-card site-nav-program-card-health site-nav-program-card-floating rounded-[1.9rem] px-5 py-5 text-white [animation-delay:0.8s]">
                                <span class="site-nav-program-card-glow"></span>
                                <span class="site-nav-program-card-badge inline-flex rounded-full bg-white/18 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/90">Kategori</span>
                                <div class="mt-6 flex min-h-[7.25rem] items-end justify-between gap-4">
                                    <div>
            ...
            <div class="site-nav-program relative">
                <a href="{{ $pelajarId ? route('staff.temuduga.program', $pelajarId) : route('institusi') }}" class="site-nav-link {{ request()->routeIs('staff.temuduga.*') ? 'is-active bg-orange-50 text-orange-600' : 'text-slate-700 hover:bg-slate-50 hover:text-orange-500' }} inline-flex items-center rounded-full px-4 py-3 text-sm font-semibold">
                    Institusi
                </a>
                ...
                <div class="site-nav-program-panel absolute left-1/2 top-full z-20 w-[min(92vw,32rem)] pt-4">
                    <div class="site-nav-program-shell rounded-[2rem] p-3 sm:p-4">
                        ...
                        <div class="grid gap-3 md:grid-cols-3">
                            <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'TVET']) : route('institusi', ['jenis' => 'TVET']) }}" class="site-nav-program-card site-nav-program-card-tvet site-nav-program-card-floating rounded-[1.9rem] px-5 py-5 text-white [animation-delay:0s]">
                                <span class="site-nav-program-card-glow"></span>
                            ...
                            <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'Diploma']) : route('institusi', ['jenis' => 'Diploma']) }}" class="site-nav-program-card site-nav-program-card-diploma site-nav-program-card-floating rounded-[1.9rem] px-5 py-5 text-white [animation-delay:0.4s]">
                                <span class="site-nav-program-card-glow"></span>
                                <span class="site-nav-program-card-badge inline-flex rounded-full bg-white/18 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/90">Program</span>
                                <div class="mt-6 flex min-h-[7.25rem] items-end justify-between gap-4">
                                    <div>
                            ...
                            <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'Sains Kesihatan']) : route('institusi', ['jenis' => 'Sains Kesihatan']) }}" class="site-nav-program-card site-nav-program-card-health site-nav-program-card-floating rounded-[1.9rem] px-5 py-5 text-white [animation-delay:0.8s]">
                                <span class="site-nav-program-card-glow"></span>
                                <span class="site-nav-program-card-badge inline-flex rounded-full bg-white/18 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/90">Program</span>
                                <div class="mt-6 flex min-h-[7.25rem] items-end justify-between gap-4">
                                    <div>
        ...
        <details class="site-nav-mobile ml-auto lg:hidden">
            ...
            <div class="site-nav-mobile-panel absolute inset-x-4 top-full mt-3 rounded-3xl border border-slate-200 bg-white p-4 shadow-[0_24px_60px_rgba(15,23,42,0.14)] sm:inset-x-6">
                <div class="space-y-2">
                    <a href="{{ $pelajarId ? route('staff.temuduga.program', $pelajarId) : route('program') }}" class="{{ request()->routeIs('staff.temuduga.program') ? 'bg-orange-50 text-orange-600' : 'text-slate-700 hover:bg-slate-50 hover:text-orange-500' }} block rounded-2xl px-4 py-3 text-sm font-semibold">
                        Program
                    </a>
                    <div class="grid gap-3 rounded-[1.6rem] bg-slate-50/90 p-3 sm:grid-cols-3">
                        <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'TVET']) : route('kursus.index', ['jenis' => 'TVET']) }}" class="site-nav-mobile-program-card site-nav-program-card-tvet rounded-[1.5rem] px-4 py-4 text-white">
                        ...
                        <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'Diploma']) : route('kursus.index', ['jenis' => 'Diploma']) }}" class="site-nav-mobile-program-card site-nav-program-card-diploma rounded-[1.5rem] px-4 py-4 text-white">
                            <span class="inline-flex rounded-full bg-white/18 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/85">Kategori</span>
                        ...
                        <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'Sains Kesihatan']) : route('kursus.index', ['jenis' => 'Sains Kesihatan']) }}" class="site-nav-mobile-program-card site-nav-program-card-health rounded-[1.5rem] px-4 py-4 text-white">
                            <span class="inline-flex rounded-full bg-white/18 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/85">Kategori</span>
                    ...
                    <a href="{{ $pelajarId ? route('staff.temuduga.program', $pelajarId) : route('institusi') }}" class="{{ request()->routeIs('staff.temuduga.*') ? 'bg-orange-50 text-orange-600' : 'text-slate-700 hover:bg-slate-50 hover:text-orange-500' }} block rounded-2xl px-4 py-3 text-sm font-semibold">
                        Institusi
                    </a>
                    <div class="grid gap-3 rounded-[1.6rem] bg-slate-50/90 p-3 sm:grid-cols-3">
                        <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'TVET']) : route('institusi', ['jenis' => 'TVET']) }}" class="site-nav-mobile-program-card site-nav-program-card-tvet rounded-[1.5rem] px-4 py-4 text-white">
                        ...
                        <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'Diploma']) : route('institusi', ['jenis' => 'Diploma']) }}" class="site-nav-mobile-program-card site-nav-program-card-diploma rounded-[1.5rem] px-4 py-4 text-white">
                            <span class="inline-flex rounded-full bg-white/18 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/85">Program</span>
                            <p class="mt-4 text-lg font-semibold tracking-[-0.03em]">Diploma</p>
                            <p class="mt-1 text-xs leading-6 text-white/80">Cari institusi diploma.</p>
                        </a>
                        <a href="{{ $pelajarId ? route('staff.temuduga.listkursus', ['pelajar' => $pelajarId, 'nama' => 'Sains Kesihatan']) : route('institusi', ['jenis' => 'Sains Kesihatan']) }}" class="site-nav-mobile-program-card site-nav-program-card-health rounded-[1.5rem] px-4 py-4 text-white">
                            <span class="inline-flex rounded-full bg-white/18 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/85">Program</span>
                            <p class="mt-4 text-lg font-semibold tracking-[-0.03em]">Sains Kesihatan</p>
